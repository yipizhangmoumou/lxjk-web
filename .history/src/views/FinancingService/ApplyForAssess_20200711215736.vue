    ...
    <div class="table-container">
      ...
      <div class="table">
        ...
        >
          ...
          <el-table-column prop="financingPlanStatus" label="融资申请" :formatter="financingPlanStatus"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    financingPlanStatus(row){
        if (row.applyResult == '1') return '未申请'
      if (row.applyResult == '2') return '已申请'
    }
    /**
     * @dir 反选
     * @param null
