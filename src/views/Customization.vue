        ...
        <div class="table-info">
            ...
            <div class="table-body">
                ...
                <div class="title">
                    ...
                    <div>
                        <el-button type="primary" icon="el-icon-s-open" @click="goProductCustomization()">定制融资产品/查看详情
                        </el-button>
                    </div>
                </div>
                <div class="table">
                ...
                <div class="title">
                    ...
                    <div>
                        <el-button type="primary" icon="el-icon-s-open" v-show="!showwrite" @click="writeCompany">
                            完善企业信息
                        </el-button>
                    </div>
                </div>
                    ...
                    <div class="most-div pd20">
                        <el-tabs type="border-card" class="j_tabs j_customtabs" :stretch="true">
                            <el-tab-pane>
                                ...
                                <el-form v-if="!showwrite" label-position="top" ref="companyInfo" :rules="rules"
                                         label-width="80px" :model="companyInfo">
                                    <el-row>
                                        <el-col :span="8">
                                            <div class=""><i class="redrules">*</i> 企业全称</div>
                                            <el-button class="pdl10" disabled type="text">
                                                {{companyInfo.enterpriseInfo.name}}
                                            </el-button>
                                        </el-col>
                                        <el-col :span="8">
                                            <div class=""><i class="redrules">*</i> 企业性质</div>
                                            <el-button class="pdl10" disabled type="text">
                                                {{enterpriseNature[companyInfo.enterpriseInfo.enterpriseNature]}}
                                            </el-button>
                                        </el-col>
                                        <el-col :span="8">
                                            <div class=""><i class="redrules">*</i> 行业类型</div>
                                            <el-button class="pdl10" disabled type="text">{{industryTextinfo}}
                                            </el-button>
                                        </el-col>
                                    </el-row>
                                    <el-row>
                                        ...
                                        <el-col :span="8">
                                            ...
                                            <el-button class="pdl10" disabled type="text">
                                                {{companyInfo.enterpriseInfo.regAddress}}
                                            </el-button>
                                        </el-col>
                                        <el-col :span="8">
                                            <div class=""><i class="redrules">*</i> 成立时间</div>
                                            <el-button class="pdl10" disabled type="text">
                                                {{companyInfo.enterpriseInfo.regTime}}
                                            </el-button>
                                        </el-col>
                                    </el-row>
                                    <el-row>
                                        <el-col :span="8">
                                            ...
                                            <el-button class="pdl10" disabled type="text">
                                                {{companyInfo.businessInfo.currentYearRevenue}}
                                            </el-button>
                                        </el-col>
                                        <el-col :span="8">
                                            <div class=""><i class="redrules">*</i> 上年度销售收入</div>
                                            <el-button class="pdl10" disabled type="text">
                                                {{companyInfo.businessInfo.lastYearRevenue}}
                                            </el-button>
                                        </el-col>
                                        <el-col :span="8">
                                            <div class=""><i class="redrules">*</i> 上年度开票收入</div>
                                            <el-button class="pdl10" disabled type="text">
                                                {{companyInfo.businessInfo.lastYearInvoiceAmount}}
                                            </el-button>
                                        </el-col>
                                    </el-row>
                                    <el-row>
                                        <el-col :span="8">
                                            ...
                                            <el-button class="pdl10" disabled type="text">
                                                {{companyInfo.enterpriseAssetInfo.hasRealEstate?'是':'否'}}
                                            </el-button>
                                        </el-col>
                                        <el-col :span="8" v-show="!!companyInfo.enterpriseAssetInfo.hasRealEstate">
                                            <div class=""><i class="redrules">*</i> 不动产价值</div>
                                            <el-button class="pdl10" disabled type="text">
                                                {{realEstateVal[companyInfo.enterpriseAssetInfo.realEstateVal]}}
                                            </el-button>
                                        </el-col>
                                        <el-col :span="8">
                                        </el-col>
                                    ...
                                    <el-row>
                                        <el-col :span="8">
                                            ...
                                            <el-button class="pdl10" disabled type="text">
                                                {{companyInfo.enterpriseAssetInfo.hasEquipment?'是':'否'}}
                                            </el-button>
                                        </el-col>
                                        <el-col :span="8" v-show="!!companyInfo.enterpriseAssetInfo.hasEquipment">
                                            <div class=""><i class="redrules">*</i> 设备价值</div>
                                            <el-button class="pdl10" disabled type="text">
                                                {{equipmentVal[companyInfo.enterpriseAssetInfo.equipmentVal]}}
                                            </el-button>
                                        </el-col>
                                        <el-col :span="8">
                                        </el-col>
                                    ...
                                    <el-row>
                                        <el-col :span="8">
                                            ...
                                            <el-button class="pdl10" disabled type="text">
                                                {{companyInfo.enterpriseAssetInfo.hasSharePledge?'是':'否'}}
                                            </el-button>
                                        </el-col>
                                    </el-row>
                                </el-form>
                                    ...
                                    <el-row>
                                        <el-col :span="8">
                                            ...
                                            <el-form-item prop="enterpriseInfo.name">
                                                <el-input type="text" v-model="companyInfo.enterpriseInfo.name">{{}}
                                                </el-input>
                                            </el-form-item>
                                        </el-col>
                                        <el-col :span="8">
                                            <div class=""><i class="redrules">*</i> 企业性质</div>
                                            <el-select v-model="companyInfo.enterpriseInfo.enterpriseNature"
                                                       placeholder="请选择">
                                                <el-option
                                        ...
                                        <el-col :span="8">
                                            ...
                                            <el-form-item prop="industryType">
                                                <el-cascader :options="industryTypeArr"
                                                             v-model="companyInfo.industryType" :show-all-levels="false"
                                    ...
                                    <el-row>
                                        <el-col :span="8">
                                            ...
                                            <el-form-item prop="area_code">
                                                <el-cascader @change="areaCascader" :options="areaTree"
                                                             v-model="companyInfo.area_code" :props="props"
                                        ...
                                        <el-col :span="8">
                                            ...
                                            <el-form-item prop="enterpriseInfo.regAddress">
                                                <el-input type="text" v-model="companyInfo.enterpriseInfo.regAddress">
                                                    {{}}
                                                </el-input>
                                            </el-form-item>
                                        </el-col>
                                    ...
                                    <el-row>
                                        <el-col :span="8">
                                            ...
                                            <el-form-item prop="businessInfo.currentYearRevenue">
                                                <el-select v-model="companyInfo.businessInfo.currentYearRevenue"
                                                           placeholder="请选择">
                                                    <el-option
                                        ...
                                        <el-col :span="8">
                                            ...
                                            <el-form-item prop="businessInfo.lastYearRevenue">
                                                <el-select v-model="companyInfo.businessInfo.lastYearRevenue"
                                                           placeholder="请选择">
                                                    <el-option
                                        ...
                                        <el-col :span="8">
                                            ...
                                            <el-form-item prop="businessInfo.lastYearInvoiceAmount">
                                                <el-select v-model="companyInfo.businessInfo.lastYearInvoiceAmount"
                                                           placeholder="请选择">
                                                    <el-option
                                    ...
                                    <el-row>
                                        <el-col :span="8">
                                            ...
                                            <el-form-item prop="enterpriseAssetInfo.hasRealEstate">
                                                ...
                                                <el-select v-model="companyInfo.enterpriseAssetInfo.hasRealEstate"
                                                           placeholder="请选择">
                                                    <el-option
                                        ...
                                        <el-col :span="8">
                                            <div v-show="!!companyInfo.enterpriseAssetInfo.hasRealEstate">
                                                ...
                                                <el-form-item prop="enterpriseAssetInfo.realEstateVal">
                                                    <el-select v-model="companyInfo.enterpriseAssetInfo.realEstateVal"
                                                               placeholder="请选择">
                                                        <el-option
                                    ...
                                    <el-row>
                                        <el-col :span="8">
                                            ...
                                            <el-form-item prop="enterpriseAssetInfo.hasEquipment">
                                                <el-select v-model="companyInfo.enterpriseAssetInfo.hasEquipment"
                                                           placeholder="请选择">
                                                    <el-option
                                        ...
                                        <el-col :span="8">
                                            <div v-show="!!companyInfo.enterpriseAssetInfo.hasEquipment">
                                                ...
                                                <el-form-item prop="enterpriseAssetInfo.equipmentVal">
                                                    <el-select v-model="companyInfo.enterpriseAssetInfo.equipmentVal"
                                                               placeholder="请选择">
                                                        <el-option
                                    ...
                                    <el-row>
                                        <el-col :span="8">
                                            ...
                                            <el-form-item prop="enterpriseAssetInfo.hasPatent">
                                                <el-select v-model="companyInfo.enterpriseAssetInfo.hasPatent"
                                                           placeholder="请选择">
                                                    <el-option
                                        ...
                                        <el-col :span="8">
                                            <div v-show="!!companyInfo.enterpriseAssetInfo.hasPatent">
                                                ...
                                                <el-form-item prop="enterpriseAssetInfo.patentVal">
                                                    <el-select v-model="companyInfo.enterpriseAssetInfo.patentVal"
                                                               placeholder="请选择">
                                                        <el-option
                                    ...
                                    <el-row>
                                        <el-col :span="8">
                                            ...
                                            <el-form-item prop="enterpriseAssetInfo.hasSharePledge">
                                                <el-select v-model="companyInfo.enterpriseAssetInfo.hasSharePledge"
                                                           placeholder="请选择">
                                                    <el-option
                            ...
                            <el-tab-pane>
                                ...
                                <el-form v-if="!showwrite" :model="companyInfo">
                                    <el-row>
                                        <el-col :span="8">
                                            ...
                                            <el-button class="pdl10" disabled type="text">
                                                {{companyInfo.legalRepresentative.name}}
                                            </el-button>
                                        </el-col>
                                        <el-col :span="8">
                                            <div class="">法人年龄</div>
                                            <el-button class="pdl10" disabled type="text">
                                                {{age[companyInfo.legalRepresentative.age]}}
                                            </el-button>
                                        </el-col>
                                    </el-row>
                                    <el-row>
                                ...
                                <el-form v-if="showwrite" ref="companyInfo" :rules="rules" :model="companyInfo">
                                    <el-row>
                                        <el-col :span="8">
                                            ...
                                            <el-form-item prop="legalRepresentative.name">
                                                <el-input type="text" v-model="companyInfo.legalRepresentative.name">
                                                    {{}}
                                                </el-input>
                                            </el-form-item>
                                        </el-col>
                                        <el-col :span="8">
                                            <div class="">法人年龄</div>
                                            <el-select class="ml_0" v-model="companyInfo.legalRepresentative.age"
                                                       placeholder="请选择">
                                                <el-option
                                    ...
                                    <el-row>
                                        <el-col :span="16">
                                            <div class="" style="margin-bottom:15px"><i class="redrules">*</i> 法人身份证
                                            </div>
                                            <el-upload
                                                    class="pdl10"
                                ...
                                <el-form v-if="!showwrite" :model="companyInfo">
                                    <el-row>
                                        <el-col :span="8">
                                            ...
                                            <el-image class="pdl10"
                                                      :src="'data:image/png;base64,'+businessLicenseBase64"></el-image>
                                        </el-col>
                                    </el-row>
                                </el-form>
                                <el-form v-if="showwrite" :model="companyInfo">
                                    <el-row>
                                        <el-col :span="8">
                                            <div class="" style="margin-bottom:15px"><i class="redrules">*</i> 企业营业证件
                                            </div>
                                            <el-upload
                                                    class="ml_0"
                                                    style="display:inline-block;margin-left:20px"
                                ...
                                <el-form v-if="!showwrite" :model="companyInfo">
                                    <el-row>
                                        <el-col :span="8">
                                            ...
                                            <el-button class="pdl10" disabled type="text">
                                                {{companyInfo.financialInformation.bankName}}
                                            </el-button>
                                        </el-col>
                                        <el-col :span="8">
                                            <div class=""><i class="redrules">*</i> 银行账号</div>
                                            <el-button class="pdl10" disabled type="text">
                                                {{companyInfo.financialInformation.cardNum}}
                                            </el-button>
                                        </el-col>
                                        <el-col :span="8">
                                            <div class=""><i class="redrules">*</i> 所在区域</div>
                                    ...
                                    <el-row>
                                        <el-col :span="8">
                                            ...
                                            <el-button class="pdl10" disabled type="text">
                                                {{companyInfo.financialInformation.depositBank}}
                                            </el-button>
                                        </el-col>
                                        <el-col :span="8">
                                            <div class=""><i class="redrules">*</i> 税号</div>
                                            <el-button class="pdl10" disabled type="text">
                                                {{companyInfo.financialInformation.taxNumber}}
                                            </el-button>
                                        </el-col>
                                        <el-col :span="8">
                                    ...
                                    <el-row>
                                        <el-col :span="8">
                                            ...
                                            <el-form-item prop="financialInformation.bankName">
                                                <el-input type="text"
                                                          v-model="companyInfo.financialInformation.bankName"></el-input>
                                            </el-form-item>
                                        </el-col>
                                        <el-col :span="8">
                                            <div class=""><i class="redrules">*</i> 银行账号</div>
                                            <el-form-item prop="financialInformation.cardNum">
                                                <el-input type="text"
                                                          v-model="companyInfo.financialInformation.cardNum"></el-input>
                                            </el-form-item>
                                        </el-col>
                                        <el-col :span="8">
                                            <div class=""><i class="redrules">*</i> 所在区域</div>
                                            <el-form-item prop="comfinan_areaCode">
                                                <el-cascader :options="areaTree" @change="bankCascader"
                                                             v-model="companyInfo.comfinan_areaCode" :props="props"
                                                             clearable></el-cascader>
                                            </el-form-item>
                                        </el-col>
                                    </el-row>
                                    <el-row>
                                        <el-col :span="8">
                                            ...
                                            <el-form-item prop="financialInformation.depositBank">
                                                <el-input type="text"
                                                          v-model="companyInfo.financialInformation.depositBank"></el-input>
                                            </el-form-item>
                                        </el-col>
                                        <el-col :span="8">
                                            <div class=""><i class="redrules">*</i> 税号</div>
                                            <el-form-item prop="financialInformation.taxNumber">
                                                <el-input type="text"
                                                          v-model="companyInfo.financialInformation.taxNumber"></el-input>
                                            </el-form-item>
                                        </el-col>
                                        <el-col :span="8">
                                            <div class=""><i class="redrules">*</i> 发票抬头</div>
                                            <el-form-item prop="enterpriseInfo.name">
                                                <el-input type="text"
                                                          v-model="companyInfo.enterpriseInfo.name"></el-input>
                                            </el-form-item>
                                        </el-col>
                                    </el-row>
                                </el-form>
  ...
  methods: {
      ...
      listData.forEach((item) => {
        if (showData == item.code) {
          if (type == 1) {
            ...
            } else if (this.areaText.length == 2) {
            ...
            } else if (this.areaTextbank.length == 2) {
    ...
    saveNew () {
      if (!this.businessLicense) {
        return this.$msgError('请上传企业营业证件')
      }
